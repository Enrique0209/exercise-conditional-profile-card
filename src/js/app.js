...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name || "No name"} ${variables.lastName ||
    "No Last Name"}</h1>
          <h2>${variables.role || "None"}</h2>
          <h3>${variables.city || "No city"}</h3>
          <h3>${variables.country || "No country"}</h3>
...
window.onload = function() {
  window.variables = {
    ...
    socialMediaPosition: "position-right" || "position-right",
